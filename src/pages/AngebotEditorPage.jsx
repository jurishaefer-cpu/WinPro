    ...
    <main className="app-main angebot-editor">
      ...
      <div className="editor-footer">
        ...
        <div className="footer-actions">
          {/* Workflow-Fortschritt läuft über den klickbaren Stepper oben – hier nur noch „Fertig". */}
          <button className="btn btn-primary btn-red" onClick={() => navigate(`/kunden/${kundeId}`)}>Fertig</button>
        </div>
      </div>
